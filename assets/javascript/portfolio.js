...
(function () {
    ...
    $(document).ready(function () {
        ...
        for (var i in links) {
            ...
            $('#marquee').append('<a href="https://youtube.com/zdripzz01' + link.link + '" target="_BLANK">' + link.name + '</a>');
    ...
    $('html').on('contextmenu', function (event) {
        ...
        img.src = "assets/others/trollface.gif"; 
        img.width = 64;
        img.height = 64;
        img.alt = "Dripzz";
    ...
    (function () {
        $.getJSON('https://freegeoip.app/json/', function (data) {
            ...
            writeLine(["Loading...", "Granting Access <span style='font-size: 14px; color: #06d;'>[:D]</span>..."], 30, function () {
                ...
                writeLine(["Access Granted! <span style='font-size: 14px; color: #0f0;'>[Success]</span>", "Welcome!<i style='color: #0f0'>" + 
